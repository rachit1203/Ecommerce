...
const LogIn = () => {
  ...
  return (
    <footer className="w-full relative bg-bg overflow-hidden flex flex-col items-start justify-start gap-[140px] tracking-[normal] mq450:gap-[35px] mq750:gap-[70px]">
      <section className="self-stretch flex flex-col items-start justify-start gap-[60px] max-w-full mq750:gap-[30px]">
        ...
        <div className="w-[1325px] flex flex-row items-center justify-start py-0 pr-5 pl-0 box-border gap-[129px] max-w-full lg:gap-[64px] mq450:gap-[16px] mq750:gap-[32px] mq1050:flex-wrap">
          ...
          <form className="m-0 w-[371px] flex flex-col items-start justify-start py-5 px-0 box-border gap-[40px] min-w-[371px] max-w-full mq450:gap-[20px] mq450:min-w-full mq1050:flex-1">
            <div className="self-stretch flex flex-col items-start justify-start gap-[48px] max-w-full mq450:gap-[24px]">
              <div className="flex flex-col items-start justify-start gap-[24px] max-w-full">
                <h1 className="m-0 relative text-17xl tracking-[0.04em] leading-[30px] font-medium font-heading-24px-bold text-button text-left mq450:text-3xl mq450:leading-[18px] mq1050:text-10xl mq1050:leading-[24px]">
                  Log in to Exclusive
                </h1>
            ...
            <div className="self-stretch flex flex-row items-center justify-between gap-[20px] mq450:flex-wrap">
              <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-col items-start justify-start">
                <div className="rounded bg-secondary-2 flex flex-row items-center justify-center py-4 px-[46px] whitespace-nowrap">
